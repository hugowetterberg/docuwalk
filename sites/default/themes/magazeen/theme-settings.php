<?php
// $Id: theme-settings.php,v 1.6.2.2.2.1 2009/06/26 22:03:18 zinv Exp $
...
function phptemplate_settings($saved_settings) {
  ...
  // Comment Field
  $form['tnt_container']['general_settings']['comment_container']['comment_field'] = array(
    '#type' => 'fieldset',
    '#title' => t('Comment Field'),
    '#description'   => t('Change the comment field.'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  // Display field description
  $form['tnt_container']['general_settings']['comment_container']['comment_field']['display_description'] = array(
    '#type' => 'checkbox',
    '#title' => t('Display field description'),
    '#default_value' => $settings['description'],
  );
  $form['tnt_container']['general_settings']['comment_container']['comment_field']['comment_field_name'] = array(
    '#type' => 'textfield',
    '#title' => t('Name'),
    '#size' => 60,
    '#default_value' => $settings['comment_field_name'],
  );
  $form['tnt_container']['general_settings']['comment_container']['comment_field']['comment_field_email'] = array(
    '#type' => 'textfield',
    '#title' => t('Email'),
    '#size' => 60,
    '#default_value' => $settings['comment_field_email'],
  );
  $form['tnt_container']['general_settings']['comment_container']['comment_field']['comment_field_website'] = array(
    '#type' => 'textfield',
    '#title' => t('Website'),
    '#size' => 60,
    '#default_value' => $settings['comment_field_website'],
  );
  $form['tnt_container']['general_settings']['comment_container']['comment_field']['comment_field_subject'] = array(
    '#type' => 'textfield',
    '#title' => t('Subject'),
    '#size' => 60,
    '#default_value' => $settings['comment_field_subject'],
  );
